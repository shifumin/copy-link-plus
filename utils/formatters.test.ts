...
describe("formatLink", () => {
  ...
  describe("markdown format", () => {
    it("should format as Markdown link", () => {
      expect(formatLink(url, title, "markdown")).toBe(
  ...
  describe("twoLines format", () => {
    it("should format as title and URL on two lines", () => {
      expect(formatLink(url, title, "twoLines")).toBe(
  ...
  describe("edge cases", () => {
    it("should handle empty title", () => {
      expect(formatLink(url, "", "markdown")).toBe(
        "[](https://example.com/page)"
      );
    ...
    it("should handle URL with special characters", () => {
      ...
      expect(formatLink(urlWithParams, title, "markdown")).toBe(
        `[Example Page](${urlWithParams})`
      );
    });
